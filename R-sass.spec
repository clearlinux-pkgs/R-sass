...
Version  : 0.4.4
Release  : 11
URL      : https://cran.r-project.org/src/contrib/sass_0.4.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sass_0.4.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669400687
