...
Version  : 0.4.3
Release  : 10
URL      : https://cran.r-project.org/src/contrib/sass_0.4.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sass_0.4.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669059623
