...
Version  : 0.4.10
Release  : 24
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/sass_0.4.10.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/sass_0.4.10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744484411
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/sass/libs/sass.so
/V4/usr/lib64/R/library/sass/libs/sass.so
