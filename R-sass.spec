...
Version  : 0.4.5
Release  : 13
URL      : https://cran.r-project.org/src/contrib/sass_0.4.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sass_0.4.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674580328
